...
//     category: z.string().min(3, "Category must be at least 3 words"),
//     title: z.string().min(3, "Title must be at least 3 words"),
//     slug: z.string().min(3, "Slug must be at least 3 words"),
//     blogcontent: z.string().min(3, "Blog Content must be at least 3 words"),
//   });
...
//                     <div {...getRootProps()}>
//                       <input {...getInputProps()} />
//                       <div className="flex justify-center bg-slate-200 items-center w-36 h-28 border-dashed rounded">
